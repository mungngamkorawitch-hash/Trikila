...
-- ทั่วไป
Config.MaxRooms              = 3          -- จำนวนห้องแข่งที่เปิดให้เล่นพร้อมกันได้
Config.MaxPlayersPerRoom     = 60         -- จำนวนผู้เล่นสูงสุดต่อ 1 ห้อง
Config.RoutingBucketOffset   = 100        -- เลข Bucket เริ่มต้น (เช่น ห้อง 1 = Bucket 101)
Config.AutoStartEnabled      = true       -- เปิดระบบกิจกรรมออโต้
Config.AutoStartTime         = "20:00"    -- เวลากิจกรรมออโต้
Config.JoinWindowSeconds     = 300        -- เวลาเปิดรับคนเข้าห้อง วิ
Config.RaceDurationSeconds   = 600        -- ระยะเวลาที่ให้แข่งจนจบ วิ หมดเวลาเตะออก
Config.CountdownSeconds      = 10         -- เวลานับถอยหลังก่อนเริ่มไฟเขียว วิ
Config.AutoCloseAfterFinish  = 60         -- หลังแข่งจบ จะปิดห้องและเตะคนเหลือออกในกี่วินาที

-- ตั้งค่ารถ
Config.RaceVehicle           = 'sultan'   -- ชื่อโมเดลรถ
Config.VehicleColor          = {r = 255, g = 69, b = 0}  -- สีรถ
Config.VehicleMods           = {}         -- ของแต่งรถที่จะใส่

-- ตั้งค่าพิกัดสนามแข่ง
Config.SpawnOrigin           = vector4(-1042.49, -2966.70, 13.95, 330.0)  -- พิกัดจุดปล่อยตัว
Config.SpawnSpacing          = 6.0        -- ระยะห่างระหว่างรถแต่ละคันตอนเสกบน Grid
Config.SpawnColumns          = 6          -- เสกรถแถวละกี่คัน
Config.SpawnStaggerMs        = 50         -- หน่วงเวลาตอนเสกรถ (ms)

-- พิกัด Checkpoint เรียงตามลำดับ
Config.Checkpoints = {
    ...
    { coords = vector3(-1042.49, -2966.70, 13.95), radius = 15.0 },  -- เส้นชัย
}

-- สี Checkpoint
Config.CheckpointColor       = {r = 255, g = 165, b = 0, a = 120}    -- สีส้ม
Config.FinishLineColor       = {r = 0,   g = 255, b = 100, a = 150}  -- สีเขียว
Config.CheckpointScale       = vector3(3.0, 3.0, 2.0)                -- ขนาด

-- ตั้งของรางวัล
-- guaranteed = 100% | special = สุ่มเปอร์เซ็นต์ดรอป
...
Config.BoostEnabled          = true       -- เปิดใช้ระบบไนตรัส
Config.BoostDuration         = 3.0        -- ใช้บูสได้นานกี่วินาที
Config.BoostPowerMultiplier  = 3.0        -- ความแรงของบูส
Config.BoostMaxCharges       = 1          -- เก็บหลอดบูสได้สูงสุดกี่ช่อง
Config.BoostCooldown         = 5.0        -- ระยะเวลาคูลดาวน์ก่อนเก็บใหม่ได้ (วิ)
Config.BoostKeyCode          = 38         -- ปุ่มกดใช้ (E)
Config.BoostMarkerColor      = {r = 0, g = 191, b = 255, a = 150}  -- สีจุดเก็บไนตรัส

-- จุดเกิดไอเทมไนตรัสตามทาง
Config.BoostMarkers = {
...
-- ตั้งค่า UI และข้อความ

Config.ShowLeaderboardTop    = 5          -- แสดงอันดับ Leaderboard สูงสุดกี่คนบนจอ
...
Config.AnnounceGlobally      = false       -- ประกาศเปิด/จบกิจกรรมให้ผู้เล่นทั้งเซิร์ฟ (false = แจ้งเฉพาะคนในห้อง)
